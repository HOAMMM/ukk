...
class StaffKasirController extends Controller
{
    ...
    {
        $staff = User::where('id_level', 3)->get(); // 3 = kasir
        return view('dashboard.staff-kasir', compact('staff'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success', 'Staff kasir berhasil ditambahkan');
    }
    ...
    public function show($id)
    {
        ...
        return view('dashboard.staff-kasir-show', compact('staff'));
    }
